...
namespace Project.Scripts.StateMachineBehaviour
{
        ...
        where TMonoBehaviour : MonoBehaviour
    {
        ...
        {
            if (animator && monoBehaviour)
            {
                SceneLinkedSMB<TMonoBehaviour>[] sceneLinkedSMBs = animator.GetBehaviours<SceneLinkedSMB<TMonoBehaviour>>();

                foreach (var sceneLinkedSmB in sceneLinkedSMBs)
                {
                    sceneLinkedSmB.InternalInitialise(animator, monoBehaviour);
                }
            }
        }
    ...
    public abstract class SealedSMB : UnityEngine.StateMachineBehaviour
    {

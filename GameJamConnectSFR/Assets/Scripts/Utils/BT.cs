...
namespace Project.Scripts.Utility
{
    ...
    [HelpURL("https://unity3d.com/fr/learn/tutorials/projects/2d-game-kit/behaviour-tree?playlist=49633")]
    public static class BT
    {
        ...
        public static Action RunCoroutine(System.Func<IEnumerator<BTState>> coroutine, float maxTimer = 0.0f) { return new Action(coroutine, maxTimer); }
        public static Action Call(System.Action fn, float maxTimer = 0.0f) { return new Action(fn, maxTimer); }
        ...
        public static Until Until(System.Func<bool> fn) { return new Until(fn); }
        ...
        public static RandomWait RandomWait(Vector2 range) { return new RandomWait(range); }
        ...
        public static WaitForAnimatorBool WaitForAnimatorBool(Animator animator, string name, bool inversed = false) { return new WaitForAnimatorBool(animator, name, inversed); }
    ...
    public class Selector : Branch
    {
        ...
        protected void ResetActiveChild()
        {
            activeChild = 0;
            if (m_shuffle)
            {
    ...
    public class Action : BTNode
    {
        ...
        public Action(System.Action fn, float maxTime = 0.0f)
        {
            this.fn = fn;
	        this.maxTime = maxTime;
        }
        public Action(System.Func<IEnumerator<BTState>> coroutineFactory, float maxTime = 0.0f)
        {
    ...
    /// <summary>
    /// Run all children, while method returns false.
    /// </summary>
    public class Until : Block
    {
        public System.Func<bool> fn;

        public Until(System.Func<bool> fn)
        {
            this.fn = fn;
        }
        ...
        public override string ToString()
        {
            return "Until : " + fn.Method.ToString();
        }
    }
    ...
    /// </summary>
    public class RandomWait : BTNode
    {
        public Vector2 range;
        float future = -1;
        public RandomWait(Vector2 range)
        {
            this.range = range;
        }
        ...
        {
            if (future < 0)
                future = Time.time + Random.Range(range.x, range.y);
        ...
        public override string ToString()
        {
            return "Wait : " + (future - Time.time) + " / " + range.x + " - " + range.y;
        }
    }
    ...
    /// <summary>
    /// Wait for an bool to be activated.
    /// </summary>
    public class WaitForAnimatorBool : BTNode
    {
        Animator animator;
        int id;
        string boolName;
        ...
        public WaitForAnimatorBool(Animator animator, string name, bool inversed = false)
        {
            this.id = Animator.StringToHash(name);
            this.boolName = name;
            this.animator = animator;
